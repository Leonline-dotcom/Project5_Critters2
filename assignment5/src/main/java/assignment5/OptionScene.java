...
public class OptionScene {
   ...
   private static ComboBox <Integer> width, height, sEnergy, lookVal, sitVal, walkVal, runVal, reprodVal, photoVal;
    ...
    private static void addBackground() {
        ImageView imageView = new ImageView(new Image(MainMenu.class.getResource("background.jpg").toExternalForm()));
  ...
  private static void addLabels(){
    ...
    worldW.setFont(Font.loadFont(MainMenu.class.getResource("Penumbra-HalfSerif-Std_35114.ttf").toExternalForm(), 10));
    worldH.setFont(Font.loadFont(MainMenu.class.getResource("Penumbra-HalfSerif-Std_35114.ttf").toExternalForm(), 10));
    startEnergy.setFont(Font.loadFont(MainMenu.class.getResource("Penumbra-HalfSerif-Std_35114.ttf").toExternalForm(), 10));
    look.setFont(Font.loadFont(MainMenu.class.getResource("Penumbra-HalfSerif-Std_35114.ttf").toExternalForm(), 10));
    sit.setFont(Font.loadFont(MainMenu.class.getResource("Penumbra-HalfSerif-Std_35114.ttf").toExternalForm(), 10));
    walk.setFont(Font.loadFont(MainMenu.class.getResource("Penumbra-HalfSerif-Std_35114.ttf").toExternalForm(), 10));
    run.setFont(Font.loadFont(MainMenu.class.getResource("Penumbra-HalfSerif-Std_35114.ttf").toExternalForm(), 10));
    minReprodEnergy.setFont(Font.loadFont(MainMenu.class.getResource("Penumbra-HalfSerif-Std_35114.ttf").toExternalForm(), 10));
    photosynthesis.setFont(Font.loadFont(MainMenu.class.getResource("Penumbra-HalfSerif-Std_35114.ttf").toExternalForm(), 10));
  ...
  private static void addComboBoxes() {
    ...
    width.getEditor().setFont(Font.loadFont(MainMenu.class.getResource("Penumbra-HalfSerif-Std_35114.ttf").toExternalForm(), 14));
